...
export default function ModalList({visible,onRequestClose,onPress,submit,onChangeText}) {
    return (
        <View>
        <Modal
        visible={visible}
          ...
          <View style={{backgroundColor: 'gray', flex: 1, opacity: 0.88}}>
            <View
              ...
              <View style={{margin: 20}}>
                <Text style={{fontSize: 15, marginBottom: 20}}>Create List</Text>
                ...
                <TouchableOpacity
                  ...
                  <View
                    ...
                    <Text style={{color: 'orange'}}>Create</Text>
                  </View>
                </TouchableOpacity>
              </View>
            </View>
